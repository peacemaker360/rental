...
class FrontendI18nTests(unittest.TestCase):
    ...
    def test_unauthenticated_start_screen_is_localized(self):
        ...
        self.assertIn('"auth.email_help": "Use the same email you will use with Cloudflare Access."', self.app_js)
    ...
    def test_mobile_utility_actions_and_user_menu_are_scoped(self):
        ...
        self.assertIn('window.location.assign("/cdn-cgi/access/logout")', self.app_js)
